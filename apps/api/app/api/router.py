...
from app.api.routes import auth, crop_intelligence, disease, geospatial, health, onboarding, spatial, version, water, weather
...
api_router.include_router(water.router, prefix="/api/v1", tags=["water-intelligence"])
api_router.include_router(crop_intelligence.router, prefix="/api/v1", tags=["crop-intelligence"])
